...
class _CalendarScreenState extends State<CalendarScreen> {
      ...
      jsonFiles = files
          .where((file) {
            if (file is File &&
                ...
                file.path.contains("run_$selectedDateString")) {
              return true;
            }
            return false;
          })
  ...
  void _deleteRecord(File jsonFile) async {
    final recordExists = await jsonFile.exists();
    if (!mounted) return;
